-- CORRECTED FINAL RECOVERY SCRIPT
-- Using the correct table structures from migrations
...
-- Import Users with correct structure
...
-- Import Companies with correct structure (no rating column)
...
-- Import Ratings with correct structure
