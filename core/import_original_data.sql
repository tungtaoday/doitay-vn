-- Import missing tables and essential data from original database

-- Create missing extensions table
...
-- Create missing reviews table (since we have ratings, we might not need this, but keep for compatibility)
...
-- Update general_settings to match original
