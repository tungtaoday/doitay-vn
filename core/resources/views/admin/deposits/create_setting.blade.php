...
<div class="row justify-content-center">
    <div class="col-lg-10">
        <div class="card b-radius--10">
            ...
            <div class="card-body">
                <form action="{{ route('admin.deposits.settings.store') }}" method="POST" enctype="multipart/form-data" id="depositSettingForm">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="payment_method" class="form-control" required>
                                    ...
                                    <option value="zalopay" {{ old('payment_method') == 'zalopay' ? 'selected' : '' }}>
                                        Ví ZaloPay
                                    </option>
                                ...
                                <div class="qr-upload-container">
                                    <div class="upload-area" id="uploadArea">
                                        <div class="upload-content">
                                            ...
                                            <h6 class="mt-2">Kéo thả QR Code vào đây</h6>
                        ...
                        <div id="ewalletFields" style="display: none;">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="wallet_phone" class="form-control" value="{{ old('wallet_phone') }}" 
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="wallet_name" class="form-control" value="{{ old('wallet_name') }}" 
                                           placeholder="VD: Nguyen Van A">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" name="min_amount" class="form-control" value="{{ old('min_amount', 10000) }}" 
                                           min="1000" required>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" name="max_amount" class="form-control" value="{{ old('max_amount', 50000000) }}" 
                                           min="1000" required>
                                    <span class="input-group-text">VNĐ</span>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" name="processing_hours" class="form-control" value="{{ old('processing_hours', 24) }}" 
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="instructions" class="form-control" rows="4" 
                                          placeholder="Nhập hướng dẫn chi tiết cho người dùng...">{{ old('instructions') }}</textarea>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="note_template" class="form-control" value="{{ old('note_template') }}" 
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <button type="submit" class="btn btn--primary">
                                    <i class="las la-save"></i> Lưu phương thức
                                </button>
...
$(document).ready(function() {
    ...
    // Form validation
    $('#depositSettingForm').on('submit', function(e) {
