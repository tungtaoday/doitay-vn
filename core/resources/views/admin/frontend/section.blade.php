    ...
    @if (@$section->content)
        <div class="row">
            <div class="col-lg-12 col-md-12 mb-30">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.frontend.sections.content', $key) }}" class="disableSubmission" method="POST" enctype="multipart/form-data" id="sectionForm">
                            @csrf
                                        ...
                                        @foreach ($item as $imgKey => $image)
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-muted">@lang('Max file size: 2MB')</small>
                                                </div>
                                            </div>
                                        @endforeach
                                    @else
            ...
            $('.image-upload-input').on('change', function() {
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        ...
                        $(this).closest('.image-upload-wrapper').find('.image-upload-preview').css('background-image', 'url(' + e.target.result + ')');
                    }.bind(this);
