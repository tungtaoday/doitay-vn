    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper">
            <ul class="sidebar__menu">
                ...
                @endif
            @endforeach
            <li class="sidebar-menu-item {{ menuActive('admin.company-wallets.*') }}">
                <a href="{{ route('admin.company-wallets.index') }}" class="nav-link">
                    <i class="menu-icon las la-wallet"></i>
                    <span class="menu-title">Quản lý ví công ty</span>
                </a>
            </li>
        </ul>
    </div>
