                ...
                <div class="contractor-card-body">
                    <div class="contractor-info">
                        ...
                        <div class="contractor-category">
                            ...
                            <span>{{ $company->category->name ?? 'Chưa phân loại' }}</span>
                        </div>
                    ...
                    <div class="contractor-rating">
                        <div class="rating-stars">
                            @php
                                $rating = $company->ratings_avg_avg_rating ?? $company->avg_rating ?? 0;
                        ...
                        <div class="rating-info">
                            ...
                            <span class="rating-count">({{ $company->ratings_count ?? 0 }} đánh giá)</span>
                        </div>
                    </div>
                    ...
                    <div class="contractor-stats">
                        <div class="stat-item">
                            ...
                            <span>{{ \Carbon\Carbon::parse($company->created_at)->locale('vi')->diffForHumans() }}</span>
                        </div>
                        <div class="stat-item">
...
function clearAllFilters() {
    // Trigger clear filters event if available
