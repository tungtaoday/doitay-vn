-- VERIFIED RECOVERY SCRIPT
-- Only tables with confirmed structures
...
-- Import Leads with correct structure
...
(4, 1, 14, '2025-01-23 10:00:00', 'Lịch hẹn xây tường ngăn', FROM_UNIXTIME(1749228921), FROM_UNIXTIME(1749228921)),
(5, 2, 15, '2025-01-24 15:00:00', 'Lịch hẹn làm tủ bếp', FROM_UNIXTIME(1749228921), FROM_UNIXTIME(1749228921));
