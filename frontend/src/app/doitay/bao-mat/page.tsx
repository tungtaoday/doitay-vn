...
export const metadata: Metadata = {
  ...
  description: 'Chính sách bảo mật thông tin cá nhân của nền tảng doitay.vn — cách chúng tôi thu thập, sử dụng và bảo vệ dữ liệu của bạn.',
  alternates: { canonical: '/doitay/bao-mat' },
};
    ...
    <div className="bg-surface">
      <div className="mx-auto max-w-3xl px-6 py-20 lg:px-8">
        ...
        <header className="mb-16 text-center">
          ...
          <p className="mt-4 text-on-surface-variant">Nền tảng doitay.vn · Cập nhật lần cuối: 14/07/2026</p>
        </header>

        <div className="prose-custom space-y-10 text-on-surface-variant">

          <Section title="1. Thông tin chúng tôi thu thập">
            <p>Khi bạn sử dụng nền tảng doitay.vn, chúng tôi có thể thu thập các thông tin sau:</p>
            <ul>
        ...
        <div className="mt-16 text-center text-sm text-outline">
          Đây là chính sách của nền tảng <strong className="text-on-surface">doitay.vn</strong>. Chính sách bảo mật của ứng dụng Zalo Mini App “Ground Truth - Hồ Sơ Thợ” xem tại{' '}
          <Link href="/bao-mat" className="text-primary underline">doitay.vn/bao-mat</Link>.
        </div>
      </div>
    </div>
  );
