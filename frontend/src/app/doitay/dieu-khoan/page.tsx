...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/doitay/dieu-khoan' },
};
...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 pb-32 pt-16 lg:px-8">
      ...
      <p className="mt-3 text-sm text-outline">Nền tảng doitay.vn · Cập nhật lần cuối: 01/05/2026</p>
      ...
      <div className="mt-16 space-y-4 text-center">
        <p className="text-sm text-outline">
          Đây là điều khoản của nền tảng <strong className="text-on-surface">doitay.vn</strong>. Điều khoản của ứng dụng Zalo Mini App “Ground Truth - Hồ Sơ Thợ” xem tại{' '}
          <Link href="/dieu-khoan" className="text-primary underline">doitay.vn/dieu-khoan</Link>.
        </p>
        <Link
          href="/"
