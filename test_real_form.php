...
try {
    ...
    echo "🧪 Test form submission thật...\n";
    ...
    echo "\n📝 Simulate form submission với số điện thoại mới: 0888999000\n";
    
    // Dữ liệu form giả lập (như form thật)
    $formData = [
        'zalo_phone' => '0888999000',
        'zalo_name' => 'Tư vấn viên test',
    ...
    try {
        ...
        echo "2. Xem số điện thoại có hiển thị 0888999000 không\n";
        echo "3. Nếu hiển thị đúng, hãy thử thay đổi và lưu\n";
        echo "4. Xem có bị reset về 0888999000 không\n";
