...
<head>
    ...
    <title>Test Zalo Widget - Simple</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>🧪 Test Zalo Widget - Simple Version</h1>
        
        <div class="test-info">
            <h3>📋 Hướng dẫn test:</h3>
            <p><strong>1.</strong> Nhìn góc phải dưới màn hình - bạn sẽ thấy nút chat màu xanh</p>
            <p><strong>2.</strong> Click vào nút chat để mở chat window</p>
            <p><strong>3.</strong> Mở Developer Tools (F12) để xem console log</p>
        </div>
        
        <div class="test-info">
            <h3>🔍 Kiểm tra Console:</h3>
            <p>Sẽ thấy: "🎉 Zalo Chat Widget đã được load trực tiếp!"</p>
        </div>
        
        <p style="text-align: center; color: #666; margin-top: 30px;">
            Nếu bạn thấy nút chat màu xanh ở góc phải dưới → Widget hoạt động! 🎉
        </p>
    </div>

    <!-- Zalo Chat Widget - Simple -->
        ...
        ">
            ...
            ">
                ...
                ">
                    ...
                    <span style="font-size: 11px; opacity: 0.7;">14:30</span>
                </div>
            </div>
    ...
    console.log('🎉 Zalo Chat Widget đã được load trực tiếp!');
    console.log('📱 Widget sẽ hiển thị ở góc phải dưới màn hình');
    
    // Test if widget elements exist
    setTimeout(() => {
        const widget = document.getElementById('zalo-chat-widget');
        const button = document.getElementById('zalo-chat-button');
        const window = document.getElementById('zalo-chat-window');
        
        console.log('Widget element:', widget ? '✅ Tồn tại' : '❌ Không tồn tại');
        console.log('Button element:', button ? '✅ Tồn tại' : '❌ Không tồn tại');
        console.log('Chat window element:', window ? '✅ Tồn tại' : '❌ Không tồn tại');
        
        if (widget && button && window) {
            console.log('🎉 Tất cả elements đã được tạo thành công!');
        } else {
            console.log('❌ Có vấn đề với việc tạo elements!');
        }
    }, 1000);
    </script>
</body>
